...
def executeChangeCommand(device_name, newValue, speed=None) -> List[any, PiError]:
...
def executeFunction(function_name, function_params) -> List[any, PiError]:
...
def executeMinerFunction(command, hosts=[]) -> List[any, PiError]:
